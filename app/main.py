...
from app.api import teacher, student, subjects, classes, admin_notifications, student_notification, attendance_analysis, bulk_register
...
app.include_router(bulk_register.router)
